...
export default function Calendar() {
	...
	let monthName = currentDate.toLocaleDateString(config.defaultLanguage, {
		month: 'long',
		year: 'numeric'
	});
	monthName = monthName.substring(0, 1).toUpperCase() + monthName.substring(1); // yes i know, don't scream at me.
				...
				<div className="max-w-7xl mx-auto flex items-center justify-between">
					<div>
						<h1 className="text-2xl font-bold text-slate-900" data-testid="page-title">
							{strings.HEADLINE_TITLE}
						</h1>
						<p className="text-slate-600 mt-1">{strings.HEADLINE_DESC}</p>
					</div>
